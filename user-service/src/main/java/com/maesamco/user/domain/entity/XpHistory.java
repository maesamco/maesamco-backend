 ...
 * {@code source_event_id IS NOT NULL} 부분 UNIQUE 인덱스로 보장하고,
 * 문제별 최초 정답 중복 지급은 V8의 사용자·문제 부분 UNIQUE 인덱스로
 * 최종 차단합니다.</p>
 *
 ...
 * </ul>
 *
 * <p>사용자별 최신순 조회에는 V6에서 추가한
 * {@code (user_id, earned_at DESC, id DESC)} 복합 인덱스를 사용합니다.</p>
 */
@Getter
@Entity
@Table(
