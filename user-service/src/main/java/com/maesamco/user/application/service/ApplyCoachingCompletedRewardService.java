...
/**
 * 코칭 완료 보상 반영을 조정하고 동시 갱신 충돌을 재시도합니다.
 *
 * <p>각 시도는 {@link ApplyCoachingCompletedRewardTransaction}에서 독립된
...
public class ApplyCoachingCompletedRewardService {
    ...
    private final ApplyCoachingCompletedRewardTransaction
            rewardTransaction;
    ...
    public boolean apply(
        ...
        throw new IllegalStateException(
                "코칭 완료 보상 재시도 흐름이 비정상적으로 종료되었습니다."
        );
    }
