...
public class CurriculumService {
     ...
     *
     * @param request 커리큘럼 생성 요청
     * @return 생성된 커리큘럼 정보
     */
    @Transactional(rollbackFor = Exception.class)
    public CurriculumCreateResponse createCurriculum(
        ...
        return CurriculumCreateResponse.from(
                savedCurriculum
        );
    }
     ...
     */
    @Transactional(readOnly = true)
    public PageResponse<CurriculumResponse> searchCurriculums(
            Pageable pageable
    ) {
