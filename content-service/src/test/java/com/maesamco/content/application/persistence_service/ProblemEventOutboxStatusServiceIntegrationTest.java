...
import com.maesamco.content.application.persistence_service.event_outbox.ProblemEventOutboxStatusService;
...
@EnableJpaRepositories(
        ...
        excludeFilters = @ComponentScan.Filter(
                ...
                classes = {
                        ProblemCommandRepository.class,
                        ProblemQueryRepository.class
                }
        )
)
@Transactional(
