...
/**
 * RedisHintGenerationLockAdapterTest와 동일한 이유 — Mockito로는 실제 Redis의
 * SETNX/TTL/Lua 스크립트 동작을 검증할 수 없다(재검증 PR #111, 외부 AI 리뷰의 재시도
 * 상한 동시성 우회 지적 대응).
 */
class RedisAiFeedbackRetryLockAdapterTest {

    private static GenericContainer<?> redisContainer;
    private static RedisAiFeedbackRetryLockAdapter lockAdapter;
    ...
    static void startRedis() {
        ...
        lockAdapter = new RedisAiFeedbackRetryLockAdapter(redisTemplate, new SimpleMeterRegistry());
    }
